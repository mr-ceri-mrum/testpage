                    ...
                    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/withdraw">
                                <span class="nav-link-text">Создание уроков</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/history">
                                <span class="nav-link-text">Список Уроков</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/add">
                                <span class="nav-link-text">addlessons</span>
                            </a>
                        </li>
            ...
            <footer class="sticky-footer">
                <div class="container">
                    <div class="text-center">
                        <small>&copy; Gratly Academy</small>
                    </div>
                </div>
            </footer>
        <?php endif; ?>
