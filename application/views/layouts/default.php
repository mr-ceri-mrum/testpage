...
<html lang="en">
    ...
    <body>
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                <a class="navbar-brand" href="/">Ваш кабинет</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <?php if (isset($_SESSION['account']['id'])): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="/dashboard/lessons">Уроки</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/postlist/">postlist</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/dashboard/referrals">?????</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/account/profile/edit">Настройки</a>
                            </li>
                        <?php else: ?>
                            <li class="nav-item">
